/// Shared macOS history panel width.
pub(crate) const PANEL_WIDTH: f64 = 420.0;

/// Shared macOS history panel height.
pub(crate) const PANEL_HEIGHT: f64 = 412.0;
...
/// Shared outer inset used by the history panel.
...
/// Shared preferences window width.
pub(crate) const PREFERENCES_WIDTH: f64 = 548.0;

/// Shared preferences window height.
